<template>
  <f7-page no-toolbarr>
    ...
    <f7-list-item>
        ...
        <f7-input :value="username" @input="username = $event.target.value" type="text" placeholder="" info="Watch out! It's case sensetive" required validate clear-button></f7-input>
    </f7-list-item>

    <f7-list-item>
        <f7-icon icon="demo-list-icon" slot="media"></f7-icon>
        <f7-label>E-mail</f7-label>
        <f7-input :value="email" @input="email = $event.target.value" type="email" placeholder="" info="We'll need your real email for verification" required validate clear-button></f7-input>
    </f7-list-item>

    <f7-list-item>
        <f7-icon icon="demo-list-icon" slot="media"></f7-icon>
        <f7-label>Password</f7-label>
        <f7-input :value="password" @input="password = $event.target.value" type="password" placeholder="" info="Password must conform with Cognito's policy" required validate clear-button></f7-input>
    </f7-list-item>
    </f7-list>
